...
namespace DXLocalizationNugetGenerator
{
    class Program
    {
        static int Main(string[] args)
        {
            ...
            //    @"-inputDXNuGetPath=C:\Program Files (x86)\DevExpress 20.2\Components\System\Components\packages",
            //    @"-inputLocalizationPath=D:\Playground\devexpress-nuget-localization\source\localization",
            //    @"-outputLanguageCode=cs",
            //    @"-outputNuspecPath=D:\Playground\devexpress-nuget-localization\target\nuspec"};
#endif
